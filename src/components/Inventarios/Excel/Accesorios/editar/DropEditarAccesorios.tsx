...
export const DropEditarAccesorios = () => {
  ...
  const { uploadExcelAccesorios, loading, statusMessage, success } =
    useEditarAccesoriosExcel();

  const { obtenerAccesoriosExcel } = useAccesoriosExcel();
  ...
  const handleDownload = async () => {
    ...
    try {
      const data = await obtenerAccesoriosExcel(sedeId);
    ...
    <div className="bg-white border border-gray-100 rounded-[28px] shadow-testimonial p-5 sm:p-6 h-full flex flex-col">
      ...
      <div className="flex items-center gap-4 mb-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-base font-bold text-dark">Editar Accesorios</h2>
        </div>
