...
const PaymentMethod = () => {
      ...
      <table className="w-full border border-gray-300 text-sm text-center">
        ...
        <tbody>
          <tr>
            ...
            <td><input name="od_esf" value={formData.od_esf} onChange={handleChange} className="w-full p-1 border" /></td>
            <td><input name="od_cil" value={formData.od_cil} onChange={handleChange} className="w-full p-1 border" /></td>
            <td><input name="od_eje" value={formData.od_eje} onChange={handleChange} className="w-full p-1 border" /></td>
            <td><input name="od_dip" value={formData.od_dip} onChange={handleChange} className="w-full p-1 border" /></td>
          </tr>

          <tr>
            <td className="font-semibold">OI</td>
            <td><input name="oi_esf" value={formData.oi_esf} onChange={handleChange} className="w-full p-1 border" /></td>
            <td><input name="oi_cil" value={formData.oi_cil} onChange={handleChange} className="w-full p-1 border" /></td>
            <td><input name="oi_eje" value={formData.oi_eje} onChange={handleChange} className="w-full p-1 border" /></td>
            <td><input name="oi_dip" value={formData.oi_dip} onChange={handleChange} className="w-full p-1 border" /></td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <div>
    ...
    <div className="flex flex-wrap gap-4 text-sm">
      {["Carey", "Acetato", "Metal", "TR-90", "Aluminio"].map((item) => (
        <label key={item} className="flex items-center gap-2">
          <input
            type="radio"
