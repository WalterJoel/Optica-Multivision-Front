...
const paymentMethods: {
  ...
  icon: string;
}[] = [
    {
      ...
      label: "Efectivo",
      icon: "/images/cart/efectivo.webp",
    },
    {
      key: MetodoPago.TRANSFERENCIA,
      label: "Interbancario",
      icon: "/images/cart/int.webp",
    },
            ...
            >
              <div className="relative z-10">
                <Image
                  ...
                  width={120}
                  height={120}
                  className={`w-auto object-contain transition-transform duration-300 ${method.key === MetodoPago.EFECTIVO || method.key === MetodoPago.TRANSFERENCIA
                      ? "h-[92px] scale-135"
                      : "h-[60px]"
                    }`}
                  unoptimized
