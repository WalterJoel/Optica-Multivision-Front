...
const Signin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ CLAVE: avisar a toda la app (Header/AuthGate/Chat)
          ...
          <form onSubmit={handleLogin} className="flex-1 bg-white p-7 sm:p-10 md:p-[50px]">
            ...
            <div className="mt-6">
              ...
              <input
                ...
                className="w-full rounded-[10px] border border-[#e2e8f0] px-3.5 py-3 text-[15px] outline-none transition placeholder:text-[#94a3b8] focus:border-[#2563eb] focus:ring-4 focus:ring-[rgba(37,99,235,.15)]"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="mt-6 w-full rounded-[10px] bg-[#2563eb] py-3 text-[16px] font-bold text-white shadow-[0_10px_20px_rgba(37,99,235,.25)] hover:bg-[#1d4ed8] active:translate-y-[1px] transition"
            >
              Login
            </button>
